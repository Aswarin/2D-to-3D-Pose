...
class TIPSy(Model):
    ...
    def train_step(self, pose_batch):
        ...
        with tf.GradientTape(persistent=True) as gen_tape:
            ...
            right_leg_loss = (cross_entropy_loss * (3 / 16) * 0.15) + (right_leg_rotation_loss * 10) + (
                        right_leg_90 * 3)
            left_leg_loss = (cross_entropy_loss * (3 / 16) * 0.15) + (left_leg_rotation_loss * 10) + (left_leg_90 * 3)
            torso_loss = (cross_entropy_loss * (4 / 16) * 0.15) + (torso_rotation_loss * 10) + (torso_90 * 3)
            right_arm_loss = (cross_entropy_loss * (3 / 16) * 0.15) + (right_arm_rotation_loss * 10) + (
                        right_arm_90 * 3)
            left_arm_loss = (cross_entropy_loss * (3 / 16) * 0.15) + (left_arm_rotation_loss * 10) + (left_arm_90 * 3)
...
if __name__ == '__main__':
    ...
    gen_filepath = '5_way_independent_weights/GAN_2/'
