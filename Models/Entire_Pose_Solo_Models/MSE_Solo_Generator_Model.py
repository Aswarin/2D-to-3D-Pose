...
class Solo_GAN(Model):
    ...
    def train_step(self, pose_batch):
        ...
        with tf.GradientTape() as gen_tape:
            ...
            cross_entropy_loss = self.mse(misleading_labels, disc_predictions)

            student_loss = (cross_entropy_loss) + (comparison_2d_loss * 10) + (consistency_loss * 3)
...
if __name__ == '__main__':
    ...
    gen_filepath = 'solo_gen_weights/MSE_2/'
