...
import numpy as np
import json
from Label_Smoothing_Solo_Model import build_student_generator
import pandas as pd
...
loss_type = 'MSE'
model_number = '1'
student_weight_location = 'solo_gen_weights/' + loss_type + '_' + model_number + '/' # Load in the generator weights from a h5 file
...
all_errors.to_csv('solo_generator_errors_' + loss_type + '_' + model_number + '.csv', index=False)